 ...
 * 線材移轉
 */
public class LocationMoveActivity extends AppCompatActivity {
    ...
    private Button btnLocSelectionList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.btnLocSelectionList = this.findViewById(R.id.locSelectionBtn);
        this.btnLocSelectionList.setOnClickListener(this::goLocSelection);
        this.btnLocSelectionList.setFocusable(false);
            ...
            if (keyCode == KeyEvent.KEYCODE_ENTER && event.getAction() == KeyEvent.ACTION_UP) {
                ...
                AsyncTask<EditText, Void, Boolean> chkJobTask = new AsyncTask<EditText, Void, Boolean>() {
                    ...
                    protected Boolean doInBackground(EditText...views) {
                        ...
                        try {
                            System.out.println("doinbak1");
                            ApiResponse chkStokExistResp = Ion.with(LocationMoveActivity.this)
                                    .load(chkJobUrl)
                                    .as(new TypeToken<ApiResponse>() {})
                                    .get();
                            System.out.println("doinbak2");
                            result = true;
                            message = "";
                            if (chkStokExistResp.status == ApiResponse.Status.ERROR){
                                System.out.println("doinbak3:" + chkStokExistResp.status);
                                result = false;
                                message = "查無此批號資料";
                                return false;
                            }
                    ...
                    protected void onPostExecute(Boolean result) {
                        if (!result.booleanValue()){
                            LocationMoveActivity.this.myMediaPlay.play(MP3.beepError);
                            showAlert(message);
...
//                    return false;
//                }
//                boolean isExist = LocationMoveActivity.this.myDao.chkLoc("G", locNo);
//                if (!isExist) {
//                    System.out.println("dddss");
//                    showAlert("查無此庫位資訊 \n" +
//                              "廠別: G \n" +
//                              "庫位:" + locNo);
//                    LocationMoveActivity.this.locEt.requestFocus();
//                    return true;
//                }
//            }
//            return false;
//        });
        this.locEt.setOnKeyListener((view, keyCode, event) -> {
            if (keyCode == KeyEvent.KEYCODE_ENTER && event.getAction() == KeyEvent.ACTION_UP) {
                ...
                boolean isExist = this.myDao.chkLoc("G", this.locEt.getText().toString());
                System.out.println("focus aadd");
                if (!isExist) {
                    showAlert("查無此庫位資訊 \n" +
//                              "廠別: G \n" +
                              "庫位:" + this.locEt.getText().toString());
...
//        this.locEt.setOnFocusChangeListener(new View.OnFocusChangeListener(){
//            @Override
//            public void onFocusChange(View view, boolean hasFocuse) {
//                if(!hasFocuse){
//                    if(hasError){
//                        EditText xx = (EditText)findViewById(view.getId());
//                        xx.requestFocus();
//                    }
//                }
//            }
...
//                this.insertData();
        ...
        btnQuery.setOnClickListener(view -> {
            ...
            LocationMoveActivity.this.startActivity(intent);
        });
    ...
    protected void onResume() {
        ...
        AsyncTask<Void, Void, Void> task = new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... voids) {
                LocationMoveActivity.this.basLocList =
                        LocationMoveActivity.this.myDao.getLocationList("G");
                LocationMoveActivity.this.procMastList =
                        LocationMoveActivity.this.myDao.getProcMastList();
                return null;
            }
...
//                get loc spinner content
                ...
                for (BasLoc basLoc : LocationMoveActivity.this.basLocList) {
                    locList.add(basLoc.getLocNo());
                }

                ArrayAdapter<String> arrayAdapter =
                        new ArrayAdapter<String>(LocationMoveActivity.this, R.layout.spinner_item, locList);

                arrayAdapter.setDropDownViewResource(R.layout.spinner_item);

                LocationMoveActivity.this.locSpinner.setAdapter(arrayAdapter);

                LocationMoveActivity.this.locSpinner.setSelection(0);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        System.out.println("loc:" + intent.getStringExtra("loc"));
        if (intent != null){
            this.locEt.setText(intent.getStringExtra("loc"));
            this.barcodeEt.setText(intent.getStringExtra("jobNo"));
            this.procEt.setText(intent.getStringExtra("procNo"));
        }

    }

    private void goLocSelection(View view){
        Intent intent = new Intent(this, LocSelectionActivity.class);
        intent.putExtra("loc",this.locEt.getText().toString());
        intent.putExtra("jobNo", this.barcodeEt.getText().toString());
        intent.putExtra("procNo", this.procEt.getText().toString());
//        this.startActivity(intent);
    ...
    private void insertData() {
        ...
        AsyncTask<View, Void, Boolean> insertMainDataTask = new AsyncTask<View, Void, Boolean>() {
            ...
            protected Boolean doInBackground(View... views) {
                ...
                if (LocationMoveActivity.this.myApplication.isConnected()) {
                    ...
                    try {
                        ...
                        if (chkStokExistResp.status == ApiResponse.Status.OK) {
                            mainData = LocationMoveActivity.this.createMainData();

                            ApiResponse<Integer> apiResponse =
                                    Ion.with(LocationMoveActivity.this)
                        ...
                        ex.printStackTrace();
                        mainData = LocationMoveActivity.this.createMainData();      // 新增到 SQLite
            ...
            protected void onPostExecute(Boolean result) {
                ...
                if (result) {
                    ...
                    procEt.setText("");
                    procNameEt.setText("");
                    LocationMoveActivity.this.myMediaPlay.play(MP3.sweet);
                    showToast(message);
                } else {
                    LocationMoveActivity.this.myMediaPlay.play(MP3.beepError);
                    showAlert(message);
    ...
    private MainData createMainData() {
        ...
        mainData.setKind(MoveKind.PackLocMove.getValue());
...
//        mainData.setLocate(this.locSpinner.getSelectedItem().toString());
        mainData.setLocate(this.locEt.getText().toString());
    ...
    public class UploadTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... voids) {
            ...
            try {
                apiResponse = Ion.with(LocationMoveActivity.this)
        ...
        protected void onPostExecute(Boolean success) {
            ...
            if (success) {
                ...
                LocationMoveActivity.this.myMediaPlay.play(MP3.sweet);
                LocationMoveActivity.this.showAlert(msg);
            } else {
