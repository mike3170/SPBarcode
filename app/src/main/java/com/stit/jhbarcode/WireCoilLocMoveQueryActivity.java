...
public class WireCoilLocMoveQueryActivity extends AppCompatActivity {
    ...
    private void datePickerLsnr(View v) {
        ...
        if (TextUtils.isEmpty(this.scanDate.getText().toString())) {
            ...
            new DatePickerDialog(this, (view, year, month, dayOfMonth) -> {
                ...
                WireCoilLocMoveQueryActivity.this.scanDate.setText(dateFormatWithSlash.format(cal.getTime()));
            }, yy, mm, dd).show();
    ...
    private class MyTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            this.uploaded = WireCoilLocMoveQueryActivity.this.tbUploaded.isChecked();
            this.scanDate = WireCoilLocMoveQueryActivity.this.scanDate.getText().toString();
        }
        ...
        protected Boolean doInBackground(Void... voids) {
            ...
            if (uploaded) {
                ...
                try {
                    ...
                    ApiResponse<List<MainData>> apiResponse = Ion.with(WireCoilLocMoveQueryActivity.this)
                            .load(url)
        ...
        protected void onPostExecute(Boolean success) {
            ...
            if (success) {
                LocationMoveListAdapter adapter = new LocationMoveListAdapter(
                        WireCoilLocMoveQueryActivity.this,
                        mainDataList,
                        dsKind,
                        tvQueryCount
                );
