...
public class HeadCoilLocMoveQueryActivity extends AppCompatActivity {
    ...
    private void datePickerLsnr(View v) {
        ...
        if (TextUtils.isEmpty(this.scanDate.getText().toString())) {
            ...
            new DatePickerDialog(this, (view, year, month, dayOfMonth) -> {
                ...
                HeadCoilLocMoveQueryActivity.this.scanDate.setText(dateFormatWithSlash.format(cal.getTime()));
            }, yy, mm, dd).show();
    ...
    private void doQuery(View v) {
        ...
        Date _date = DateUtils.string2Date(scanDate);
        if (_date == null) {
    ...
    private class MyTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            this.uploaded = HeadCoilLocMoveQueryActivity.this.tbUploaded.isChecked();
            this.scanDate = HeadCoilLocMoveQueryActivity.this.scanDate.getText().toString();
        }
        ...
        protected Boolean doInBackground(Void... voids) {
            ...
            if (uploaded) {
                ...
                try {
                    ...
                    ApiResponse<List<MainData>> apiResponse = Ion.with(HeadCoilLocMoveQueryActivity.this)
                            .load(url)
                ...
                Date _scanDate = string2Date(scanDate);
        ...
        protected void onPostExecute(Boolean success) {
            ...
            if (success) {
                LocationMoveListAdapter adapter = new LocationMoveListAdapter(
                        HeadCoilLocMoveQueryActivity.this,
                        mainDataList,
                        dsKind,
                        tvQueryCount
                );
